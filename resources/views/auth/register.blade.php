...
@section('pageTitle', 'صفحه ثبت نام')
@section('body')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="email"
                                       class="col-md-2 col-form-label text-md-right">{{ __('ایمیل') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password"
                                       class="col-md-2 col-form-label text-md-right">{{ __('پسورد') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm"
                                       class="col-md-2 col-form-label text-md-right">{{ __('تایید پسورد') }}</label>
