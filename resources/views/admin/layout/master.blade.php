...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/kamadatepicker.css') }}">
    <!-- jQuery 2.2.0 -->
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="/logout" class="btn btn-rounded ">خروج</a>
                    </li>
                    <li class="dropdown messages-menu">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">وب سایتی</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
        ...
        <!-- /.search form -->
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('admin.category.index')}}"><i class="fa fa-circle-o"></i>لیست دسته ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-cart-plus"></i>
                        <span>مدیریت عکس ها</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('admin.photo.list')}}"><i class="fa fa-circle-o"></i>لیست عکس ها</a></li>
                    </ul>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    <a href="{{route('admin.tickets.answer')}}">
                        <i class="fa fa-cart-plus"></i>
                        <span>پاسخگویی به تیکت ها</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                </li>
            {{--   <li class="treeview">
...
--}}{{--                        <li><a href="{{route('admin.pay.list')}}"><i class="fa fa-circle-o"></i>لیست پرداخت نشده ها </a></li>--}}{{--
                   </ul>
               </li>--}}
        </section>
        <!-- /.sidebar -->
    ...
    <footer class="main-footer" style="margin-top: 10px">
        ...
        <strong>Copyright &copy; 2019 <a href="https://www.axnegar.com">axnegar</a>.</strong> All rights
        reserved.
    </footer>
